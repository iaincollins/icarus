...
Code contributions, pull requests and bug reports are not currently being accepted.

You are free to fork this codebase and use it to make your own app.

Information below is provided for developers wishing to do this or to build from source.
